...
public class WebSecurityConfig  extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers( "/resources/**","/storage/**", "/h2-console/**", "/console/**","/webjars/**","/registration/**","/","/home","/newUser","/aboutUs/**","/contact/**","/public/**","/owner/**","/registrationConfirm/**","/CompleteRegistration/**","/REST/**").permitAll()

package com.thorton.grant.uspto.prototypewebapp.config.host.bean.aws.ba;
...
@Profile("AWSba")
@Configuration
@PropertySource("classpath:server-host-AWS-ba1.properties")
public class AWSbaHostConfig implements ServerHostConfig {

...
public class ApplicationFlowController {
    ...
    // hopefully just a redirect here, we won't need to add the applicaiton and credentials to the model
    @RequestMapping({"/officeAction/optional/owner/Ind/edit/{actionID}/{email}"})
    public String optionalActionOwnerIndvUSInfoEdit(WebRequest request, Model model, @PathVariable String actionID,@PathVariable String email, @RequestParam("trademarkID") String trademarkInternalID) {
    ...
    // hopefully just a redirect here, we won't need to add the applicaiton and credentials to the model
    @RequestMapping({"/officeAction/optional/owner/corp/edit/{actionID}/{email}"})
    public String optionalActionOwnerCorpUSInfoEdit(WebRequest request, Model model, @PathVariable String actionID, @PathVariable String email, @RequestParam("trademarkID") String trademarkInternalID) {
    ...
    // hopefully just a redirect here, we won't need to add the applicaiton and credentials to the model
    @RequestMapping({"/officeAction/optional/owner/estate/edit/{actionID}/{email}"})
    public String optionalActionOwnerEstateUSInfoEdit(WebRequest request, Model model, @PathVariable String actionID,@PathVariable String email, @RequestParam("trademarkID") String trademarkInternalID) {
        ...
        return "application/office_action/optional_actions/owner/estate/ownerEdit";
    }
    ...
    // hopefully just a redirect here, we won't need to add the applicaiton and credentials to the model
    @RequestMapping({"/officeAction/optional/owner/solp/edit/{actionID}/{email}"})
    public String optionalActionOwnerSolpUSInfoEdit(WebRequest request, Model model, @PathVariable String actionID, @PathVariable String email, @RequestParam("trademarkID") String trademarkInternalID) {
        ...
        return "application/office_action/optional_actions/owner/solP/ownerEdit";
    }
    ...
    // hopefully just a redirect here, we won't need to add the applicaiton and credentials to the model
    @RequestMapping({"/officeAction/optional/owner/jv/edit/{actionID}/{email}"})
    public String optionalActionOwnerJointVentureUSInfoEdit(WebRequest request, Model model, @PathVariable String actionID, @PathVariable String email, @RequestParam("trademarkID") String trademarkInternalID) {
        ...
        return "application/office_action/optional_actions/owner/jointVC/ownerEdit";
    }
    ...
    // hopefully just a redirect here, we won't need to add the applicaiton and credentials to the model
    @RequestMapping({"/officeAction/optional/owner/llp/edit/{actionID}/{email}"})
    public String optionalActionOwnerLLPUSInfoEdit(WebRequest request, Model model,@PathVariable String actionID, @PathVariable String email, @RequestParam("trademarkID") String trademarkInternalID) {
        ...
        return "application/office_action/optional_actions/owner/llp/ownerEdit";
    }
    ...
    // hopefully just a redirect here, we won't need to add the applicaiton and credentials to the model
    @RequestMapping({"/officeAction/optional/owner/partner/edit/{actionID}/{email}"})
    public String optionalActionOwnerPartnerUSInfoEdit(WebRequest request, Model model, @PathVariable String actionID, @PathVariable String email, @RequestParam("trademarkID") String trademarkInternalID) {
        ...
        return "application/office_action/optional_actions/owner/partnership/ownerEdit";
    }
    ...
    // hopefully just a redirect here, we won't need to add the applicaiton and credentials to the model
    @RequestMapping({"/officeAction/optional/owner/trust/edit/{actionID}{email}"})
    public String optionalActionOwnerTrustUSInfoEdit(WebRequest request, Model model, @PathVariable String actionID, @PathVariable String email, @RequestParam("trademarkID") String trademarkInternalID) {
        ...
        return "application/office_action/optional_actions/owner/trust/ownerEdit";
    }
    ...
    @RequestMapping({"/noa/response/{actionID}"})
    public String respondToNoticeOfAllowance( Model model, @PathVariable String actionID ,@RequestParam("trademarkID") String trademarkInternalID){
    ...
    public String optionalActionsMain( Model model, @PathVariable String actionID ,@RequestParam("trademarkID") String trademarkInternalID){
        ...
        model.addAttribute("prevURL", actions.getSection8PrevLink());

        model.addAttribute("actionType", actions.getActionType());
    ...
    public String optionalActionsPathController(WebRequest request, Model model,  @PathVariable String direction, @PathVariable String actionID ,@RequestParam("trademarkID") String trademarkInternalID){
       ...
       if(trademarkInternalID.contains(",")){
           trademarkInternalID = trademarkInternalID.substring(0, trademarkInternalID.indexOf(","));
       }
       ...
       // check for duplicated action id
    ...
    @RequestMapping({"/renew/response/{actionID}"})
    public String respondToExtenstionRequest( Model model, @PathVariable String actionID ,@RequestParam("trademarkID") String trademarkInternalID){
        ...
        return "application/postReg/section8";
    }



    @Transactional
    @RequestMapping({"/postReg/section8/incontestable/{actionID}"})
    public String postRegSection8Declarations
            (WebRequest request, Model model, @PathVariable String actionID ,@RequestParam("trademarkID") String trademarkInternalID){
        ...
        return "application/postReg/incontestable";
    ...
    // global action controller for attorney
    @Transactional
    @RequestMapping({"/globalAction/optional/attorney/"})
    public String globalActionsAttorney(WebRequest request, Model model,@RequestParam("trademarkID") String trademarkInternalID){
        ...
        officeActions.setAttorneyOptional(true);
